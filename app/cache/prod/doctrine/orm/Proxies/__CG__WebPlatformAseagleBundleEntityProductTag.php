 ...
 */
class ProductTag extends \WebPlatform\AseagleBundle\Entity\ProductTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'WebPlatform\\AseagleBundle\\Entity\\ProductTag' . "\0" . 'id', '' . "\0" . 'WebPlatform\\AseagleBundle\\Entity\\ProductTag' . "\0" . 'tagId', '' . "\0" . 'WebPlatform\\AseagleBundle\\Entity\\ProductTag' . "\0" . 'productId', 'tag', 'product');
        }
